  ...
  <div class="signup-container">
    <div class="signup-card">
      ...
      <form @submit.prevent="signup" class="signup-form">
        ...
        <button type="submit" class="signup-button student-theme">
          <span>signup</span>
          <i class="fas fa-arrow-right"></i>
        </button>

        <div class="links">
          <router-link to="/student-login">Existing Student? Login here</router-link>
        </div>
      </form>
    </div>
  </div>
...
export default {
  ...
  methods: {
    signup() {
      fetch('http://127.0.0.1:5000/api/student_signup', {
        method: 'POST',
        headers: {
